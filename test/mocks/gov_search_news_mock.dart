class FakeGovSearchNewsResponse {
  static jsonMock() => {
        "resultado": {
          "noticias": {
            "noticia": [
              {
                ...
                "dataDePublicacao": "Tue Jun 21 00:00:00 BRT 2016",
                "link":
                    "http://www.sdh.gov.br/noticias/stf-acata-denuncia-contra-o-deputado-jair-bolsonaro-por-incitacao-ao-crime-de-estupro/",
                "resumo":
                    "A primeira turma do Supremo Tribunal Federal decidiu abrir duas ações penais contra o deputado Jair Bolsonaro (PSC-RJ). O parlamentar torna-se réu por ter afirmado ao jornal Zero Hora, em dezembro de 2014, que não estupraria a deputada Maria do",
                "idFonte": 96,
                "descricao":
